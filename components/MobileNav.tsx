...
const MobileNav=({user}:MobileNavProps)=>{
    ...
    return (
        <section className='w-full max-w-[264px]'>
            ...
            width={34}
            height={34} alt="Horizon logo"
            ></Image>
            <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>GlobalBank</h1>
        </Link>
            <div className='mobilenav-sheet'>
                ...
                return(
                    ...
                    className={cn ('mobilenav-sheet_close w-full',{'bg-bank-gradient':isActive})}>
                            ...
                            width={20} height={20} className={cn({'brightness-[3] invert-0':isActive})}></Image>
